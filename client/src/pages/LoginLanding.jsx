...
import { ShieldIcon, ArrowRightIcon, UserIcon } from 'lucide-react'
  ...
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
        ...
        overflow-y-auto min-h-screen'>
          ...
          <div className='w-full max-w-d animate-fade-in relative-z-10'>
            ...
            <div className='space-y-4'>
               {portaloptions.map((portal) => (
                    ...
                    rounded-lg p-5 sm:p-6 transition-all duration-300 hover:border-indigo-400 hover:bg-indigo-50'>
                    <div className='relative z-10 flex items-center justify-between gap-4 sm:gap-5'>
                      ...
                      <ArrowRightIcon className='w-4 h-4 text-slate-400 group-hover:text-indigo-600 group-hover:
